      ...
      <div className="mx-auto max-w-[1200px] px-6 lg:px-12 pt-16 pb-24 grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-5">
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            ...
            <Button variant="secondary" icon="Code" href="https://github.com/CtrlAltcouk" external iconRight="ExternalLink">GitHub</Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex flex-col gap-3">
              <SocialLink name="Instagram" handle="@ctrlalt.prints" brand="instagram" href="https://www.instagram.com/ctrlaltprint3d/" />
              <SocialLink name="YouTube"   handle="@ctrlaltprints"  brand="youtube"   href="https://youtube.com" />
              <SocialLink name="CrealityCloud" handle="CtrlAlt"  brand="printables" href="https://www.crealitycloud.com/user/5670334343" />
            </div>
          </div>
