...
const FILES = [
  ...
  {
    name: 'Toyota Corolla AE86 Wireframe Wall Art',
    file: 'toyota_ae86_wallart.3mf',
    diff: 'easy',
    category: 'Decor',
    nozzle: '0.4mm', layer: '0.2mm', infill: '10% grid', material: 'PLA', supports: 'No',
    blurb: 'Single-line wireframe of the iconic AE86 hachi-roku, designed to print flat and hang on a wall. A must for any car enthusiast.',
